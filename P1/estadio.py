...
class Estadio:
    ...
    def cadastrar_estadio(self):
        self.nome = input("Informe o nome do estadio: ")
        self.pais = input("Informe o preço do estadio: ")
        self.cidade = input("Informe a cidade do estadio: ")
        self.capacidade = input("Informe a capacidade do estadio: ")
        estadio = {"nome": self.nome, "pais": self.pais, "cidade": self.cidade,
                   "capacidade": self.capacidade}
        mycolEstadio.insert_one(estadio)
        return print("Estadio incluído com sucesso!")

    @staticmethod
    def alterar_estadio():
        exibir_estadios()
        estadio_escolhido = {"_id": ObjectId(input("Informe o ID do estadio a ser alterado: "))}
        atributo_escolhido = input("\nInforme o atributo (exatamente como está abaixo) a ser alterado no estadio:\n"
    ...
    def excluir_estadio(tudo):
        if tudo:
            ...
            exibir_estadios()
            mycolEstadio.delete_one({"_id": ObjectId(input("Informe o ID do estadio a ser excluído: "))})
